...
const SparkleIcon = (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden>
    <path
      d="M9 1.5l1.9 5.6L16.5 9l-5.6 1.9L9 16.5l-1.9-5.6L1.5 9l5.6-1.9L9 1.5Z"
      fill="currentColor"
    />
  </svg>
);
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              ...
              >
                <span
                  aria-hidden
                  className={`mb-5 inline-flex h-11 w-11 items-center justify-center rounded-[13px] ${feature.iconBg} ${feature.iconText}`}
                >
                  {feature.icon}
                </span>
